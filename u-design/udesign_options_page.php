	...
	function init_udesign_theme_options() {
		...
		add_option( "udesign_options",
		    array( // intitialize the 'udesign_options' array with the following key => value pairs:
			    ...
			    "gs_slide_img_url_1" => esc_url_raw( get_template_directory_uri().'/sliders/flashmo/grid_slider/photos/940x400_slide_01.jpg' ),
			    ...
			    "gs_no_js_img" => esc_url_raw( get_template_directory_uri().'/sliders/flashmo/grid_slider/photos/940x400_slide_01.jpg' ),
			    "pm_image_width" => 940,
			    "pm_image_height" => 360,
			    "pm_segments" => 7,
			    "pm_tween_time" => 5,
			    ...
			    "pm_slide_img_url_1" => esc_url_raw( get_template_directory_uri().'/sliders/piecemaker/images/940x360_slide_01.jpg' ),
			    "pm_no_js_img" => esc_url_raw( get_template_directory_uri().'/sliders/piecemaker/images/940x360_slide_01.jpg' ),
			    "pm2_image_width" => 940,
			    ...
			    "pm2_slide_img_url_1" => esc_url_raw( get_template_directory_uri().'/sliders/piecemaker_2/contents/940x360_slide_01.jpg' ),
			    ...
			    "pm2_no_js_img" => esc_url_raw( get_template_directory_uri().'/sliders/piecemaker_2/contents/940x360_slide_01.jpg' ),
...
<?php           $show_breadcrumbs = isset( $options['show_breadcrumbs'] ) ? $options['show_breadcrumbs'] : ''; ?>
		<table class="form-table">
			...
			<tr valign="top">
			    <th scope="row"><?php esc_html_e('Image Cropping', 'udesign'); ?></th>
			    <td>
			...
			<tr valign="top">
			    <th scope="row"><?php esc_html_e('Retina Cropped Images', 'udesign'); ?></th>
			    <td>
				...
				<label for="udesign_enable_retina_images">
				    <input name="udesign_options[udesign_enable_retina_images]" type="checkbox" id="udesign_enable_retina_images" value="yes" <?php checked('yes', $options['udesign_enable_retina_images']); ?> />
                                    <?php esc_html_e("Enable automatic retina images for the ones being cropped.", 'udesign'); ?>
                                </label><br /> 
	...
	function menus_options_contentbox( $options ) { ?>
			...
			<tr valign="top">
				...
				<span> px. <?php esc_html_e('This option allows you to move the menu vertically towards the top or bottom of the Top Area ("0" is the default which places the menu at the bottom).', 'udesign'); ?></span>
                        ...
                        <tr valign="top">
                            <th scope="row"><?php esc_html_e('Main Menu Drop Shadows', 'udesign'); ?></th>
                            <td>
                                <fieldset><legend class="screen-reader-text"><span><?php esc_html_e('Main Menu Drop Shadows', 'udesign'); ?></span></legend>
...
<?php                           // The following button is use for closing the Thickbox modal only ?>
                ...
                <div id="sec-nav-bar-simulator-wrapper">
                    <div class="ui-widget ui-helper-clearfix">
                        <span class="description"><?php esc_html_e('Drop items in this menu simulator to add them to the menu. Drag and drop to change order or resize to set desired width:', 'udesign'); ?></span>
...
<?php		elseif ( $current_slider == '2' ) :
		    ...
		    require_once( trailingslashit( get_template_directory() ) . 'sliders/piecemaker/piecemakerXML.php' ); ?>
...
<?php		elseif ( $current_slider == '3' ) :
		    ...
		    // Include the Piecemaker Slider XML generator page
		    require_once( trailingslashit( get_template_directory() ) . 'sliders/piecemaker_2/piecemakerXML.php' ); ?>
		    <!-- Add invisible fields from the other sliders' forms to preserve their state. (this is only necessary for checkboxes and some text fields)  -->
		    <input style="display:none;" name="udesign_options[gs_remove_3d_shadow]" type="checkbox" id="gs_remove_3d_shadow" value="yes" <?php checked('yes', $options['gs_remove_3d_shadow']); ?> />
		    <input style="display:none;" name="udesign_options[pm_remove_3d_shadow]" type="checkbox" id="pm_remove_3d_shadow" value="yes" <?php checked('yes', $options['pm_remove_3d_shadow']); ?> />
		    <input style="display:none;" name="udesign_options[c1_sync]" type="checkbox" id="c1_sync" value="yes" <?php checked('yes', $options['c1_sync']); ?> />
